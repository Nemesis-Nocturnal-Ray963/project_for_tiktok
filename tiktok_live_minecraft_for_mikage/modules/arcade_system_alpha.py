...
class GiftWindow(arcade.View):
    ...
    def __init__(self):
        ...
        self.beams = [
            LightBeam(0, 0, (94, 255, 247),  0, 90, 1.8),                # 左下
            LightBeam(720, 0, (94, 255, 247), 90, 180, 1.8),              # 右下
            LightBeam(720, 1280, (250, 194, 222), 180, 270, 0.2),              # 右上
            LightBeam(0, 1280, (250, 194, 222), 270, 360, 0.2),           # 左上
        ]
