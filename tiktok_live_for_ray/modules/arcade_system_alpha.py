...
class GiftWindow(arcade.View):
    ...
    def __init__(self):
        ...
        self.beams = [
            LightBeam(0, 0, (90, 30, 255),  0, 90, 0.9),                # 左下
            LightBeam(720, 0, (90, 30, 255), 90, 180, 1.2),              # 右下
            LightBeam(720, 1280, (0, 100, 180), 180, 270, 0.6),              # 右上
            LightBeam(0, 1280, (0, 100, 180), 270, 360, 0.4),           # 左上
